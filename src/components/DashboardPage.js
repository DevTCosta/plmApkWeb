      ...
      try {
        if (loggedIn) {
          ...
          if (!mensagemResponse.ok) {
            throw new Error(
              `Erro ao buscar mensagem. Status: ${mensagemResponse.status}`
            );
          }
          ...
          if (!videosResponse.ok) {
            throw new Error(
              `Erro ao buscar informações dos vídeos. Status: ${videosResponse.status}`
            );
          }
      ...
      <div className="containerDashboard">
        <div className="generalContainerDashboard">
          <div
            ...
            style={{ backgroundColor: backgroundColorbar }}
          >
